...
function semen_slide() {
    if (i < semenImgArray.length) {
      ...
      function(){
        $("#Semen_mountains .natural_thumbnail img").attr("src","assets/images/"+semenImgArray[i]).fadeIn(3000,"linear",function(){ i++;
...
var dalolImgArray = ["dalol_1.jpg","dalol_2.jpg","dalol_3.jpg","dalol_4.jpg","dalol_5.jpg","dalol_6.jpeg","dalol_7.jpg","dalol_8.jpg","dalol_9.jpg","Camel-Train-Lake-Dallol---Danakil-Depression.jpg"];
function dalol_slide() {
    if (j < dalolImgArray.length) {
      $("#dalol_depression .natural_thumbnail img").first().fadeOut(1500,"swing",
      function(){
        $("#dalol_depression .natural_thumbnail img").attr("src","assets/images/"+dalolImgArray[j]).fadeIn(2500,"linear",function(){   j++;
...
//slide animation for semen Mountains depression
var clothImgArray = ["cloth_1.jpg","cloth_2.jpg","cloth_3.jpg","cloth_4.jpg","cloth_5.jpeg","cloth_5.jpg","cloth_6.jpg","cloth_6.png","cloth_7.jpg","cloth_8.jpg","cloth_9.jpg","cloth_10.jpg","cloth_11.jpg"];
...
//slide animation for ethiopian people traditional cloth depression
var eartaleImgArray = ["eartale_1.jpg","eartale_2.jpg","eartale_3.jpg","eartale_4.jpg","eartale_4.png","eartale_5.jpg","eartale_6.jpg","erta_ale.jpg","eartale_7.jpg","eartale_8.jpg","eartale_9.jpg"];
function eartale_slide() {
    if (j < eartaleImgArray.length) {
      $("#erta_ale .natural_thumbnail img").first().fadeOut(1500,"swing",
      function(){
        $("#erta_ale .natural_thumbnail img").attr("src","assets/images/"+eartaleImgArray[j]).fadeIn(2500,"linear",function(){   j++;
...
if($('nav').height() < 60){
  ...
  //$('nav ul li:nth-child(n+2)').css("margin-","95%");
